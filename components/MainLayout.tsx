...
export default function MainLayout({
  ...
  return (
    <div className={`min-h-dvh ${backgroundClassName}`}>
      ...
      >
        <div className='mx-auto flex w-full max-w-none items-center justify-between px-5 py-2 sm:px-8 lg:px-12'>
          <Link
            href='/'
      ...
      {/* ---------- Main content ---------- */}
      <main className='mx-auto w-full max-w-none px-5 sm:px-8 lg:px-12'>
        {children}
      </main>
    </div>
  );
