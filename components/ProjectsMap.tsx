...
export default function ProjectsMap({
  ...
  return (
    <div>
        ...
        >
          ...
          >
            {threadPaths.map((thread) => {
              ...
              const opacity = !thread.matchesFilter ? 0.06 : emphasize ? 1 : 0.7;
      ...
      <p className='mx-auto mt-4 max-w-2xl text-center text-xs leading-5 text-[#777066]'>
        {dict.map.disclaimer}
      </p>
      ...
      {filteredOnlineProjects.length > 0 && (
        <div className='mx-auto mt-12 max-w-2xl border-t border-[#d9d2c7] pt-8'>
          <h2 className='text-lg font-semibold leading-6 text-[rgb(54,54,54)]'>
